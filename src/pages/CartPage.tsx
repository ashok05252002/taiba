            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 h-fit">
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-2">
                    <input type="text" id="coupon" placeholder="Enter coupon code" className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-taiba-blue" />
                    <button className="bg-taiba-mustard text-black px-4 rounded-lg font-semibold">Apply</button>
                </div>
              </div>
              <Link to="/checkout">
                <motion.button 
