          ...
          <div className="p-4 flex flex-col flex-grow">
            ...
            <div className="flex items-baseline justify-between">
              ...
              <motion.button
                  ...
                  className="bg-taiba-blue text-white p-2 rounded-full disabled:bg-gray-300"
                  whileHover={product.inStock ? { scale: 1.1, rotate: 5, boxShadow: '0px 4px 10px rgba(16, 139, 250, 0.5)' } : {}}
