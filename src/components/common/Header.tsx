...
import { Search, User, Menu, X, Globe, ShoppingCart, Shield, Package, LogOut, BookOpen, Smartphone } from 'lucide-react';
import { useLanguage } from '../../hooks/useLanguage';
import { useCart } from '../../contexts/CartContext';
import MiniCart from './MiniCart';
import DeliveryModeSelector from './DeliveryModeSelector';
import LocationSelector from './LocationSelector';
import UIGuideModal from './UIGuideModal';
...
const Header: React.FC<HeaderProps> = ({ deliveryMode, setDeliveryMode }) => {
  ...
  const [isUIGuideOpen, setUIGuideOpen] = useState(false);
  ...
  return (
    <>
      ...
      <UIGuideModal isOpen={isUIGuideOpen} onClose={() => setUIGuideOpen(false)} />
    </>
  );
};
